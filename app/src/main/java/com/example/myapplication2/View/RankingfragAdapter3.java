...
public class RankingfragAdapter3 extends BaseAdapter {
    private List<Rankbydl> list = new ArrayList<>();
    private Context context;
    private String[] downloadgameinfo = new String[3];
    private Rankbydl[] temprank = new Rankbydl[100];
    public RankingfragAdapter3 (List<Rankbydl> list, Context context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.rankingfragitem_3 ,parent, false);
            holder.Ranktext1_1 = (TextView) convertView.findViewById(R.id.Ranktext1_2);
            holder.Rankname1_1 = convertView.findViewById(R.id.Rankname1_2);
            holder.Rankimage1_1 = convertView.findViewById(R.id.Rankimage1_2);
            holder.Rankintro1_1 = convertView.findViewById(R.id.Rankintro1_2);
        ...
        if(list.size()!=0)
        {
            ...
            holder.Rankintro1_1.setText(String.valueOf(list.get(position).getDowmloadnum()));
    ...
    class rankThread extends Thread{
        ...
        public  void run()
        {
            ...
            String [][]temp=dbGameService.getGameDownloadnumSort();
            SQLiteDbHelper helper = new SQLiteDbHelper(context);
            ...
            {
                temprank[k]=new Rankbydl(dbGameService.getGameDL(cursor.getString(0)),1);
                ...
                for(int m=0;m<100&&temp[m][0]!=null;m++)
                {
                    ...
                    if(cursor.getString(0).equals(temp[m][0]))
                    {
                        ...
                        temprank[k].setDowmloadnum(Integer.parseInt(temp[m][1]));
                        break;
                    }

                    temprank[k].setDowmloadnum(0);
                }
