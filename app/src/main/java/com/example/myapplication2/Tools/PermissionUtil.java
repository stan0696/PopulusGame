...
public class  PermissionUtil {
    ...
    /** 方法说明：用户说明后重新申请(统一处理是不方便，请使用不需要传permissions同名函数)
     *  @param context 应用上下文
     *  create by liuxiong at 2019/4/28 0028 20:40
     */
    @Deprecated
    ...
    public static void showDialog(final Activity activity, String message,String negativeButtonText ,String positiveButtonText,
        ...
        if(negativeButtonText==null){
            negativeButtonText=activity.getResources().getString(R.string.下载中心);
        }
        if(positiveButtonText==null){
            positiveButtonText=activity.getResources().getString(R.string.下载中心);
        }
