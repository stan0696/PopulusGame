...
public class FragmentDetails extends Fragment {
    ...
    public FragmentDetails(String introduction,String[] imgurl)
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gameIntroduction=rootView.findViewById(R.id.text_gameIntroduce);
        gameIntroduction.setText(introduction);
        getdata();
        return rootView;
    }
